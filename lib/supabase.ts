...
// Fallback to placeholder values so createClient never throws when env vars are missing.
// Real requests will still fail gracefully (returning { data: null, error: ... }).
